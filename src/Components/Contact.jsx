    ...
    <>
      ...
      <div id="contact"></div>
        <div className='contact-items-container'>
          <h3 className='contact-section-title section-title'>
            Contact
          </h3>
          <div className='form-container'>
            <form className='form-container' onSubmit={sendEmail}>
              <label className='contact-label label' for='name'>
                Name
              </label>
              <input
                type='text'
              ...
              />
              <label className='contact-label label' for='email'>
                Email
              </label>
              <input
                type='email'
                ...
                style={{ background: props.lbg, color: props.fc }}
              />
              <label className='contact-label label' for='message'>
                Message
              </label>
              <textarea
                id='message'
